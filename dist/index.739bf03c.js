...
parcelHelpers.export(exports, "isAnimatingCb", ()=>isAnimatingCb);
parcelHelpers.export(exports, "hideContent", ()=>hideContent);
...
DOM.scrollOrDragLetters = DOM.scrollOrDragText.querySelectorAll(".word > .char, .whitespace");
let slidesArr = [];
...
const isAnimatingCb = (bool)=>isAnimating = bool;
const next = ()=>{
...
const getDirection = (newPosition)=>{
    if (current < newPosition) {
        if (current === 0 && newPosition === totalSlides - 1) // go to last from first
        return "prev";
        else return "next";
    }
    if (current === totalSlides - 1 && newPosition === 0) // go to first from last
    return "next";
    else return "prev";
};
...
const hideContent = (slide, animate = false)=>{
    ...
    if (animate) (0, _gsap.gsap).timeline({
        ...
        onComplete: complete
    }).addLabel("start", 0).to(slide.DOM.content, {
        yPercent: -100
        ...
        (0, _gsap.gsap).set(slide.DOM.content, {
            yPercent: -100
        });
        (0, _gsap.gsap).set(slide.DOM.contentImg, {
            startAt: {
                transformOrigin: "50% 0%",
                scaleY: 1
            },
...
const init = ()=>{
    ...
    for (const [position, slide] of slidesArr.entries())slide.DOM.inner.addEventListener("click", ()=>{
        showContent(position);
    });
    for (const [_, slide1] of slidesArr.entries())slide1.DOM.content.addEventListener("click", ()=>{
        (0, _gsap1.toggleCursorAndBackTexts)();
        hideContent(slidesArr[current], true);
    });
};
...
init();
(0, _utils.preloadImages)(".slide__img-inner").then(()=>{
    document.body.classList.remove("loading");
});

},{"./utils":"72Dku","./slide":"a2l79","./cursor":"3v1v0","./gsap":"1TTwU","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","gsap/Observer.js":"aAWxM","splitting":"77jB6","splitting/dist/splitting.css":"3uR7n","splitting/dist/splitting-cells.css":"7jeGL"}],"72Dku":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"a2l79":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./utils":"72Dku","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1TTwU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "showContentAnimation", ()=>showContentAnimation);
parcelHelpers.export(exports, "navigateAnimation", ()=>navigateAnimation);
parcelHelpers.export(exports, "toggleCursorAndBackTexts", ()=>toggleCursorAndBackTexts);
var _gsap = require("gsap");
var _ = require(".");
const reverseDirection = (direction)=>{
    return direction === "next" ? "prev" : "next";
};
const showContentAnimation = ({ slide  })=>{
    (0, _gsap.gsap).timeline({
        ...
        onStart: ()=>{},
        onComplete: ()=>{
            (0, _.isAnimatingCb)(false);
        }
    }).addLabel("start", 0).add(()=>{
        toggleCursorAndBackTexts(true);
    }, "start").to(slide.DOM.content, {
        startAt: {
            yPercent: -200
        },
        yPercent: 100
...
const navigateAnimation = ({ currentSlide , direction , positions , nextSlide ,  })=>{
    return (0, _gsap.gsap).timeline({
        defaults: {
            duration: 0.8,
            ease: "power4.inOut"
        },
        onStart: ()=>(0, _.isAnimatingCb)(true),
        onComplete: ()=>{
    ...
    .to(currentSlide.DOM.imgs, {
        ...
        opacity: 0
    }, "start")// .addLabel("upcoming", 0.4)
    .add(()=>{
        // Set up upcoming images and text default style:
        (0, _gsap.gsap).set(nextSlide.DOM.imgs, {
            opacity: 0
        });
        (0, _gsap.gsap).set(nextSlide.DOM.chars, {
            y: direction === "next" ? "-100%" : "100%",
            rotation: direction === "next" ? 3 : -3
        });
        // Add "current" class
...
const toggleCursorAndBackTexts = (isContent)=>{
    return (0, _gsap.gsap).timeline({
        onStart: ()=>{
            (0, _gsap.gsap).set((0, _.DOM).backLetters, {
                opacity: isContent ? 0 : 1
            });
            if (isContent) (0, _.DOM).backCtrl.classList.add("frame__back--show");
        },
        onComplete: ()=>{
            (0, _.DOM).backCtrl.classList[isContent ? "add" : "remove"]("frame__back--show");
            if (!isContent) (0, _.DOM).backCtrl.classList.remove("frame__back--show");
        }
    }).to((0, _.DOM).cursorLetters, {
        duration: 0.1,
        ease: "expo",
        opacity: isContent ? 0 : 1,
        stagger: {
    ...
    }).to((0, _.DOM).scrollOrDragLetters, {
        duration: 0.1,
        ease: "expo",
        opacity: isContent ? 0 : 1,
        stagger: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","gsap":"fPSuC",".":"ebWYT"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"3uR7n":[function() {},{}],"7jeGL":[function() {},{}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire1f3e")
